...
jQuery.extend({
	...
	dobPicker: function(params) {
		...
		if (typeof(params.minimumAge) === 'undefined') params.minimumAge = 1;
		if (typeof(params.maximumAge) === 'undefined') params.maximumAge = 100;

		// set the default messages		
		$(params.daySelector).append('<option value="0">' + params.dayDefault + '</option>');
		$(params.monthSelector).append('<option value="0">' + params.monthDefault + '</option>');
		$(params.yearSelector).append('<option value="0">' + params.yearDefault + '</option>');
